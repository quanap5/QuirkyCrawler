...
public class Quirky_Feature {
	public ArrayList<MyData> Quirky_Feature(final int in_invention) throws MalformedURLException, IOException {
		...
		ArrayList<MyData> feature_Data = new ArrayList<MyData>();
		while (nextpage == "true") {
			tri = tri + 1;
...
//		Gson gson1 = new Gson();
//		String json1 = gson1.toJson(feature_Data);
...
//		String mynamefile = "Feature_quirky" + dateFormat.format(cal.getTime()) + ".txt";
//		// String
...
//			writer.write(json1);
//			writer.close();
//			System.out.println("Write FEATURES: OKKK");
//			
//		} catch (Exception e) {
