...
public class Quirky_Pitches {
	public ArrayList<MyData> Quirky_Pitches(int in_invention) throws MalformedURLException, IOException {
		...
		int tri = 1;
		ArrayList<MyData> pithes_Data = new ArrayList<MyData>();
		while (nextpage == "true") {
			tri = tri + 1;
...
//		Gson gson1 = new Gson();
//		String json1 = gson1.toJson(pithes_Data);
//		
//		// Date and current time
//		DateFormat dateFormat = new SimpleDateFormat("yyyyMMdd_HH_mm_ss");
//		Calendar cal = Calendar.getInstance();
//		String mynamefile = "Pithches_quirky" + dateFormat.format(cal.getTime()) + ".txt";
//		// String
...
//			writer.write(json1);
//			writer.close();
//			System.out.println("Write PITHES: OKKK");
//			
//		} catch (Exception e) {
